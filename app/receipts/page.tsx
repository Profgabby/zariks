...
export default async function ReceiptsPage(){
 ...
 const {data:transfers}=await supabase.from("transfers").select("id,transaction_no,description,payee_name,amount_transferred,status").in("status",["transferred","received","certified","retirement_submitted","reconciled","closed"]).order("created_at",{ascending:false});
